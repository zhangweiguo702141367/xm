...
//	@Test
	public void contextLoads() {
		IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAIqQ2wtWAQLbSY", "rI2ISnMjwymi5sFrBTndJRPJvMPTrK ");
		IAcsClient client = new DefaultAcsClient(profile);
		SingleSendMailRequest request = new SingleSendMailRequest();
		try {
			request.setAccountName("xiaomei@lxiaomei.com");
			request.setFromAlias("xiaomei");
			request.setAddressType(1);
			request.setTagName("member");
			request.setReplyToAddress(true);
			request.setToAddress("yingyiyaya@163.com");
			request.setSubject("test email");
			request.setHtmlBody("this is a test email for aliyun ");
